...
namespace RegistroDetalles.BLL
{
    public class RolesBLL
    {
        ...
        public static List<Roles>GetList(Expression<Func<Roles,bool>> cristerio)
        {
            ...
            try
            {
                lista = contexto.Roles.Where(cristerio).ToList();
            }
            catch (Exception)
            {
        ...
        public static bool DescripcionExiste(string descripcion)
        {
            Contexto contexto = new Contexto();
            bool encontrado = false;
